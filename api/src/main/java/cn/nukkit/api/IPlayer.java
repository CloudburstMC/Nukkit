...
public interface IPlayer {
     ...
     * @see cn.nukkit.api.Whitelist#isOnWhitelist(String)
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
     ...
     * @see #isWhitelisted
     * @see cn.nukkit.api.Whitelist#addToWhitelist(String)
     * @see cn.nukkit.api.Whitelist#removeFromWhitelist(String)
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
     ...
     * @see cn.nukkit.api.Server#getPlayerExact
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    Player getPlayer();
    ...
    /**
     * 返回玩家所在的服务器。<br>
     * Returns the NukkitServer carrying this player.
     *
     * @return 玩家所在的服务器。<br>the NukkitServer carrying this player.
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    Server getServer();
    ...
    /**
     * 返回这个玩家以前是否来过服务器。<br>
     * Returns if this player has played in this NukkitServer before.
     * <p>
     ...
     *
     * @return 这个玩家以前是不是玩过游戏。<br>If this player has played in this NukkitServer before.
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
