...
public interface Plugin {
     ...
     * <p>
     * <p>如果需要替换已存在的资源文件，建议使用{@link cn.nukkit.api.plugin.Plugin#saveResource(String, boolean)}<br>
     * If you need to REPLACE an existing resource file, it's recommended
     * to use {@link cn.nukkit.api.plugin.Plugin#saveResource(String, boolean)}.</p>
     *
     ...
     * @see cn.nukkit.api.plugin.Plugin#saveDefaultConfig
     * @see cn.nukkit.api.plugin.Plugin#saveResource(String, boolean)
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
     ...
     * which is normally named 'resources' and placed in plugin jar file, and copy it into data folder.</p>
     * <p>
     * <p>如果需要保存默认的资源文件，建议使用{@link cn.nukkit.api.plugin.Plugin#saveResource(String)}<br>
     * If you need to SAVE DEFAULT resource file, it's recommended
     * to use {@link cn.nukkit.api.plugin.Plugin#saveResource(String)}.</p>
     *
     * @param filename 要保存的资源文件名字。<br>The name of the resource file to save.
     * @param replace  是否替换目标文件。<br>if true, Nukkit will replace the target resource file.
     * @return 保存是否成功。<br>true if the saving action is successful.
     * @see cn.nukkit.api.plugin.Plugin#saveResource(String)
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
     ...
     * @see cn.nukkit.api.plugin.Plugin#getDataFolder
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    Config getConfig();
     ...
     *
     * @see cn.nukkit.api.plugin.Plugin#getDataFolder
     * @see cn.nukkit.api.plugin.Plugin#saveResource
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    ...
    /**
     * 返回运行这个插件的服务器的{@link cn.nukkit.api.Server}对象。<br>
     * Gets the NukkitServer which is running this plugin, and returns as a {@link cn.nukkit.api.Server} object.
     *
     * @see cn.nukkit.api.Server
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    Server getServer();
     ...
     *
     * @see cn.nukkit.api.plugin.Plugin#getDescription
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    String getName();
