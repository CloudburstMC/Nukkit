...
import cn.nukkit.api.metadata.block.Dirt;
...
public class BlockTypes {
    ...
    public static final BlockType SAPLING = IntBlock.builder().name("sapling").id(6).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0f).floodable(true).build();
    ...
    public static final BlockType WATER = IntBlock.builder().name("flowing_water").id(8).maxStackSize(0).transparent(true).solid(true).filterLight(2).hardness(100f).build();
    public static final BlockType STATIONARY_WATER = IntBlock.builder().name("water").id(9).maxStackSize(0).transparent(true).solid(true).filterLight(2).hardness(100f).build();
    public static final BlockType LAVA = IntBlock.builder().name("flowing_lava").id(10).maxStackSize(0).transparent(true).solid(true).emitLight(15).hardness(100f).build();
    public static final BlockType STATIONARY_LAVA = IntBlock.builder().name("lava").id(11).maxStackSize(0).transparent(true).solid(true).emitLight(15).hardness(100f).build();
    public static final BlockType SAND = IntBlock.builder().name("sand").id(12).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(0.5f).build();
    ...
    public static final BlockType LEAVES = IntBlock.builder().name("leaves").id(18).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.2f).build();
    public static final BlockType SPONGE = IntBlock.builder().name("sponge").id(19).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(0.6f).build();
    ...
    public static final BlockType DISPENSER = IntBlock.builder().name("dispenser").id(23).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(3.5f).blockEntityClass(DispenserBlockEntity.class).build();
    public static final BlockType SANDSTONE = IntBlock.builder().name("sandstone").id(24).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(0.8f).build();
    public static final BlockType NOTE_BLOCK = IntBlock.builder().name("note_block").id(25).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(0.8f).blockEntityClass(MusicBlockEntity.class).build();
    public static final BlockType BED = IntBlock.builder().name("bed").id(26).maxStackSize(1).diggable(true).transparent(true).solid(true).hardness(0.2f).floodable(true).blockEntityClass(BedBlockEntity.class).build();
    public static final BlockType POWERED_RAIL = IntBlock.builder().name("golden_rail").id(27).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.7f).floodable(true).build();
    public static final BlockType DETECTOR_RAIL = IntBlock.builder().name("detector_rail").id(28).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.7f).floodable(true).build();
    public static final BlockType STICKY_PISTON = IntBlock.builder().name("sticky_piston").id(29).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.7f).blockEntityClass(PistonBlockEntity.class).build();
    ...
    public static final BlockType TALL_GRASS = IntBlock.builder().name("tallgrass").id(31).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0f).floodable(true).build();
    ...
    public static final BlockType PISTON = IntBlock.builder().name("piston").id(33).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).build();
    public static final BlockType PISTON_HEAD = IntBlock.builder().name("pistonarmcollision").id(34).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).blockEntityClass(PistonBlockEntity.class).build();
    ...
    public static final BlockType FLOWER = IntBlock.builder().name("red_flower").id(38).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0f).floodable(true).build();
    ...
    public static final BlockType DOUBLE_STONE_SLAB = IntBlock.builder().name("double_stone_slab").id(43).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).build();
    public static final BlockType STONE_SLAB = IntBlock.builder().name("stone_slab").id(44).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).build();
    ...
    public static final BlockType TORCH = IntBlock.builder().name("torch").id(50).maxStackSize(64).diggable(true).transparent(true).solid(true).emitLight(14).hardness(0f).floodable(true).build();
    ...
    public static final BlockType OAK_WOOD_STAIRS = IntBlock.builder().name("oak_stairs").id(53).maxStackSize(64).diggable(true).transparent(true).solid(true).filterLight(15).hardness(2f).flammable(true).build();
    public static final BlockType CHEST = IntBlock.builder().name("chest").id(54).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2.5f).blockEntityClass(ChestBlockEntity.class).build();
    ...
    public static final BlockType FARMLAND = IntBlock.builder().name("farmland").id(60).maxStackSize(64).diggable(true).transparent(true).solid(true).filterLight(15).hardness(0.6f).build();
    public static final BlockType FURNACE = IntBlock.builder().name("furnace").id(61).maxStackSize(64).diggable(true).transparent(true).solid(true).emitLight(13).hardness(3.5f).blockEntityClass(FurnaceBlockEntity.class).build();
    public static final BlockType BURNING_FURNACE = IntBlock.builder().name("lit_furnace").id(62).maxStackSize(64).diggable(true).transparent(true).solid(true).emitLight(13).hardness(3.5f).blockEntityClass(FurnaceBlockEntity.class).build();
    public static final BlockType SIGN = IntBlock.builder().name("standing_sign").id(63).maxStackSize(16).diggable(true).transparent(true).solid(true).hardness(1f).blockEntityClass(SignBlockEntity.class).build();
    public static final BlockType WOODEN_DOOR = IntBlock.builder().name("wooden_door").id(64).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).flammable(true).build();
    public static final BlockType LADDER = IntBlock.builder().name("ladder").id(65).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.4f).build();
    public static final BlockType RAIL = IntBlock.builder().name("rail").id(66).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.7f).floodable(true).build();
    public static final BlockType COBBLESTONE_STAIRS = IntBlock.builder().name("stone_stairs").id(67).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).filterLight(15).build();
    public static final BlockType WALL_SIGN = IntBlock.builder().name("wall_sign").id(68).maxStackSize(16).diggable(true).transparent(true).solid(true).hardness(1f).blockEntityClass(SignBlockEntity.class).build();
    public static final BlockType LEVER = IntBlock.builder().name("lever").id(69).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).build();
    public static final BlockType STONE_PRESSURE_PLATE = IntBlock.builder().name("stone_pressure_plate").id(70).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).build();
    public static final BlockType IRON_DOOR = IntBlock.builder().name("iron_door").id(71).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(5f).build();
    public static final BlockType WOODEN_PRESSURE_PLATE = IntBlock.builder().name("wooden_pressure_plate").id(72).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).build();
    ...
    public static final BlockType REDSTONE_TORCH = IntBlock.builder().name("unlit_redstone_torch").id(75).maxStackSize(64).diggable(true).transparent(true).solid(true).emitLight(7).hardness(0f).floodable(true).build();
    public static final BlockType REDSTONE_TORCH_ACTIVE = IntBlock.builder().name("lit_redstone_torch").id(76).maxStackSize(64).diggable(true).transparent(true).solid(true).emitLight(7).hardness(0f).floodable(true).build();
    public static final BlockType STONE_BUTTON = IntBlock.builder().name("stone_button").id(77).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).build();
    ...
    public static final BlockType CACTUS = IntBlock.builder().name("cactus").id(81).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.4f).build();
    ...
    public static final BlockType SUGAR_CANE = IntBlock.builder().name("reeds").id(83).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0f).floodable(true).build();
    public static final BlockType JUKEBOX = IntBlock.builder().name("jukebox").id(84).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(2f).blockEntityClass(JukeboxBlockEntity.class).build();
    ...
    public static final BlockType PUMPKIN = IntBlock.builder().name("pumpkin").id(86).maxStackSize(64).diggable(true).transparent(true).solid(true).filterLight(15).hardness(1f).build();
    ...
    public static final BlockType PORTAL = IntBlock.builder().name("portal").id(90).maxStackSize(0).solid(true).filterLight(15).hardness(-1f).build();
    ...
    public static final BlockType REDSTONE_REPEATER = IntBlock.builder().name("unpowered_repeater").id(93).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0f).build();
    public static final BlockType REDSTONE_REPEATER_ACTIVE = IntBlock.builder().name("powered_repeater").id(94).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0f).build();
    ...
    public static final BlockType TRAPDOOR = IntBlock.builder().name("trapdoor").id(96).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).build();
    public static final BlockType MONSTER_EGG = IntBlock.builder().name("monster_egg").id(97).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(0.75f).build();
    public static final BlockType STONE_BRICK = IntBlock.builder().name("stonebrick").id(98).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(1.5f).build();
    ...
    public static final BlockType VINES = IntBlock.builder().name("vine").id(106).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.2f).floodable(true).build();
    public static final BlockType FENCE_GATE = IntBlock.builder().name("fence_gate").id(107).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).build();
    public static final BlockType BRICK_STAIRS = IntBlock.builder().name("brick_stairs").id(108).maxStackSize(64).diggable(true).transparent(true).solid(true).filterLight(15).hardness(2f).build();
    public static final BlockType STONE_BRICK_STAIRS = IntBlock.builder().name("stone_brick_stairs").id(109).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(1.5f).filterLight(15).build();
    ...
    public static final BlockType NETHER_BRICK_STAIRS = IntBlock.builder().name("nether_brick_stairs").id(114).maxStackSize(64).diggable(true).transparent(true).solid(true).filterLight(15).hardness(2f).build();
    public static final BlockType NETHER_WART = IntBlock.builder().name("nether_wart").id(115).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0f).floodable(true).build();
    ...
    public static final BlockType BREWING_STAND = IntBlock.builder().name("brewing_stand").id(117).maxStackSize(64).diggable(true).transparent(true).solid(true).emitLight(1).hardness(0.5f).blockEntityClass(BrewingStandBlockEntity.class).build();
    public static final BlockType CAULDRON = IntBlock.builder().name("cauldron").id(118).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).blockEntityClass(CauldronBlockEntity.class).build();
    ...
    public static final BlockType END_PORTAL_FRAME = IntBlock.builder().name("end_portal_frame").id(120).maxStackSize(64).transparent(true).solid(true).emitLight(1).hardness(-1f).build();
    ...
    public static final BlockType DROPPER = IntBlock.builder().name("dropper").id(125).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(3.5f).blockEntityClass(DropperBlockEntity.class).build();
    public static final BlockType ACTIVATOR_RAIL = IntBlock.builder().name("activator_rail").id(126).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.7f).floodable(true).build();
    public static final BlockType COCOA = IntBlock.builder().name("cocoa").id(127).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.2f).build();
    public static final BlockType SANDSTONE_STAIRS = IntBlock.builder().name("sandstone_stairs").id(128).maxStackSize(64).diggable(true).transparent(true).solid(true).filterLight(15).hardness(0.8f).build();
    ...
    public static final BlockType ENDER_CHEST = IntBlock.builder().name("ender_chest").id(130).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(22.5f).blockEntityClass(EnderChestBlockEntity.class).build();
    public static final BlockType TRIPWIRE_HOOK = IntBlock.builder().name("tripwire_hook").id(131).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0f).floodable(true).build();
    ...
    public static final BlockType SPRUCE_WOOD_STAIRS = IntBlock.builder().name("spruce_stairs").id(134).maxStackSize(64).diggable(true).transparent(true).solid(true).filterLight(15).hardness(2f).flammable(true).build();
    public static final BlockType BIRCH_WOOD_STAIRS = IntBlock.builder().name("birch_stairs").id(135).maxStackSize(64).diggable(true).transparent(true).solid(true).filterLight(15).hardness(2f).flammable(true).build();
    public static final BlockType JUNGLE_WOOD_STAIRS = IntBlock.builder().name("jungle_stairs").id(136).maxStackSize(64).diggable(true).transparent(true).solid(true).filterLight(15).hardness(2f).flammable(true).build();
    ...
    public static final BlockType WOODEN_BUTTON = IntBlock.builder().name("wooden_button").id(143).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).build();
    ...
    public static final BlockType ANVIL = IntBlock.builder().name("anvil").id(145).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(5f).build();
    public static final BlockType TRAPPED_CHEST = IntBlock.builder().name("trapped_chest").id(146).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2.5f).blockEntityClass(ChestBlockEntity.class).build();
    public static final BlockType WEIGHTED_PRESSURE_PLATE_LIGHT = IntBlock.builder().name("light_weighted_pressure_plate").id(147).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).build();
    public static final BlockType WEIGHTED_PRESSURE_PLATE_HEAVY = IntBlock.builder().name("heavy_weighted_pressure_plate").id(148).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).build();
    public static final BlockType REDSTONE_COMPARATOR_UNPOWERED = IntBlock.builder().name("unpowered_comparator").id(149).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0f).blockEntityClass(ComparatorBlockEntity.class).build();
    public static final BlockType REDSTONE_COMPARATOR_POWERED = IntBlock.builder().name("powered_comparator").id(150).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0f).blockEntityClass(ComparatorBlockEntity.class).build();
    public static final BlockType DAYLIGHT_SENSOR = IntBlock.builder().name("daylight_detector").id(151).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.2f).blockEntityClass(DaylightDetectorBlockEntity.class).build();
    ...
    public static final BlockType HOPPER = IntBlock.builder().name("hopper").id(154).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).blockEntityClass(HopperBlockEntity.class).build();
    ...
    public static final BlockType IRON_TRAPDOOR = IntBlock.builder().name("iron_trapdoor").id(167).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(5f).build();
    ...
    public static final BlockType STANDING_BANNER = IntBlock.builder().name("standing_banner").id(176).maxStackSize(16).diggable(true).transparent(true).solid(true).hardness(1f).blockEntityClass(BannerBlockEntity.class).build();
    public static final BlockType WALL_BANNER = IntBlock.builder().name("wall_banner").id(177).maxStackSize(16).diggable(true).transparent(true).solid(true).hardness(1f).blockEntityClass(BannerBlockEntity.class).build();
    public static final BlockType INVERTED_DAYLIGHT_SENSOR = IntBlock.builder().name("daylight_detector_inverted").id(178).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.2f).blockEntityClass(DaylightDetectorBlockEntity.class).build();
    public static final BlockType RED_SANDSTONE = IntBlock.builder().name("red_sandstone").id(179).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(0.8f).build();
    public static final BlockType RED_SANDSTONE_STAIRS = IntBlock.builder().name("red_sandstone_stairs").id(180).maxStackSize(64).diggable(true).transparent(true).solid(true).filterLight(15).hardness(0.8f).build();
    public static final BlockType DOUBLE_RED_SANDSTONE_SLAB = IntBlock.builder().name("double_stone_slab2").id(181).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).build();
    public static final BlockType RED_SANDSTONE_SLAB = IntBlock.builder().name("stone_slab2").id(182).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).build();
    public static final BlockType SPRUCE_FENCE_GATE = IntBlock.builder().name("spruce_fence_gate").id(183).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).build();
    public static final BlockType BIRCH_FENCE_GATE = IntBlock.builder().name("birch_fence_gate").id(184).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).build();
    public static final BlockType JUNGLE_FENCE_GATE = IntBlock.builder().name("jungle_fence_gate").id(185).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).build();
    public static final BlockType DARK_OAK_FENCE_GATE = IntBlock.builder().name("dark_oak_fence_gate").id(186).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).build();
    public static final BlockType ACACIA_FENCE_GATE = IntBlock.builder().name("acacia_fence_gate").id(187).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).build();
    ...
    public static final BlockType HARD_STAINED_GLASS_PANE = IntBlock.builder().name("hard_stained_glass_pane").id(191).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(1.8f).build();
    ...
    public static final BlockType SPRUCE_DOOR = IntBlock.builder().name("spruce_door").id(193).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).build();
    public static final BlockType BIRCH_DOOR = IntBlock.builder().name("birch_door").id(194).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).build();
    public static final BlockType JUNGLE_DOOR = IntBlock.builder().name("jungle_door").id(195).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).build();
    public static final BlockType ACACIA_DOOR = IntBlock.builder().name("acacia_door").id(196).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).build();
    public static final BlockType DARK_OAK_DOOR = IntBlock.builder().name("dark_oak_door").id(197).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).build();
    ...
    public static final BlockType ITEM_FRAME = IntBlock.builder().name("frame").id(199).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(0f).floodable(true).blockEntityClass(ItemFrameBlockEntity.class).build();
    public static final BlockType CHORUS_FLOWER = IntBlock.builder().name("chorus_flower").id(200).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.4f).build();
    ...
    public static final BlockType COLORED_TORCH_RG = IntBlock.builder().name("colored_torch_rg").id(202).maxStackSize(64).diggable(true).solid(true).transparent(true).build();
    public static final BlockType PURPUR_STAIRS = IntBlock.builder().name("purpur_stairs").id(203).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(1.5f).build();
    public static final BlockType COLORED_TORCH_BP = IntBlock.builder().name("colored_torch_bp").id(204).maxStackSize(64).diggable(true).solid(true).transparent(true).build();
    ...
    public static final BlockType END_ROD = IntBlock.builder().name("end_rod").id(208).maxStackSize(64).diggable(true).transparent(true).solid(true).emitLight(14).hardness(0f).floodable(true).build();
    ...
    public static final BlockType SHULKER_BOX = IntBlock.builder().name("shulker_box").id(218).maxStackSize(1).diggable(true).transparent(true).solid(true).hardness(2f).blockEntityClass(ShulkerBoxBlockEntity.class).build();
    ...
    public static final BlockType UNDERWATER_TORCH = IntBlock.builder().name("underwater_torch").id(239).maxStackSize(64).diggable(true).solid(true).transparent(true).build();
    public static final BlockType CHORUS_PLANT = IntBlock.builder().name("chorus_plant").id(240).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.4f).build();
    public static final BlockType STAINED_GLASS = IntBlock.builder().name("stained_glass").id(241).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.3f).build();
    ...
    public static final BlockType BEETROOT = IntBlock.builder().name("beetroot").id(244).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0f).build();
    ...
    public static final BlockType OBSERVER = IntBlock.builder().name("observer").id(251).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).build();
    ...
    public static final BlockType HARD_STAINED_GLASS = IntBlock.builder().name("hard_stained_glass").id(254).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(1.8f).build();
    ...
    public static final BlockType PRISMARINE_STAIRS = IntBlock.builder().name("prismarine_stairs").id(257).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(1.5f).build();
    public static final BlockType DARK_PRISMARINE_STAIRS = IntBlock.builder().name("dark_prismarine_stairs").id(258).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(1.5f).build();
    public static final BlockType PRISMARINE_BRICKS_STAIRS = IntBlock.builder().name("prismarine_bricks_stairs").id(259).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(1.5f).build();
    public static final BlockType STRIPPED_SPRUCE_LOG = IntBlock.builder().name("stripped_spruce_log").id(260).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(2f).build();
    public static final BlockType STRIPPED_BIRCH_LOG = IntBlock.builder().name("stripped_birch_log").id(261).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(2f).build();
    public static final BlockType STRIPPED_JUNGLE_LOG = IntBlock.builder().name("stripped_jungle_log").id(262).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(2f).build();
    public static final BlockType STRIPPED_ACACIA_LOG = IntBlock.builder().name("stripped_acacia_log").id(263).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(2f).build();
    public static final BlockType STRIPPED_DARK_OAK_LOG = IntBlock.builder().name("stripped_dark_oak_log").id(264).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(2f).build();
    public static final BlockType STRIPPED_OAK_LOG = IntBlock.builder().name("stripped_oak_log").id(265).maxStackSize(64).diggable(true).solid(true).filterLight(15).hardness(2f).build();
    ...
    public static final BlockType ACACIA_BUTTON = IntBlock.builder().name("acacia_button").id(395).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).build();
    public static final BlockType BIRCH_BUTTON = IntBlock.builder().name("acacia_button").id(396).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).build();
    public static final BlockType DARK_OAK_BUTTON = IntBlock.builder().name("acacia_button").id(397).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).build();
    public static final BlockType JUNGLE_BUTTON = IntBlock.builder().name("acacia_button").id(398).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).build();
    public static final BlockType SPRUCE_BUTTON = IntBlock.builder().name("acacia_button").id(399).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).build();
    public static final BlockType ACACIA_TRAPDOOR = IntBlock.builder().name("acacia_trapdoor").id(400).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).build();
    public static final BlockType BIRCH_TRAPDOOR = IntBlock.builder().name("acacia_trapdoor").id(401).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).floodable(true).build();
    public static final BlockType DARK_OAK_TRAPDOOR = IntBlock.builder().name("acacia_trapdoor").id(402).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).floodable(true).build();
    public static final BlockType JUNGLE_TRAPDOOR = IntBlock.builder().name("acacia_trapdoor").id(403).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).floodable(true).build();
    public static final BlockType SPRUCE_TRAPDOOR = IntBlock.builder().name("acacia_trapdoor").id(404).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).floodable(true).build();
    public static final BlockType ACACIA_PRESSURE_PLATE = IntBlock.builder().name("acacia_pressure_plate").id(405).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).build();
    public static final BlockType BIRCH_PRESSURE_PLATE = IntBlock.builder().name("acacia_pressure_plate").id(406).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).build();
    public static final BlockType DARK_OAK_PRESSURE_PLATE = IntBlock.builder().name("acacia_pressure_plate").id(407).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).build();
