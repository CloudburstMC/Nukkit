...
public class ItemTypes {
    public static final ItemType IRON_SHOVEL = IntItem.builder().id(256).name("iron_shovel").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType IRON_PICKAXE = IntItem.builder().id(257).name("iron_pickaxe").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType IRON_AXE = IntItem.builder().id(258).name("iron_axe").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    ...
    public static final ItemType WOODEN_SWORD = IntItem.builder().id(268).name("wooden_sword").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType WOODEN_SHOVEL = IntItem.builder().id(269).name("wooden_shovel").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType WOODEN_PICKAXE = IntItem.builder().id(270).name("wooden_pickaxe").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType WOODEN_AXE = IntItem.builder().id(271).name("wooden_axe").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType STONE_SWORD = IntItem.builder().id(272).name("stone_sword").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType STONE_SHOVEL = IntItem.builder().id(273).name("stone_shovel").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType STONE_PICKAXE = IntItem.builder().id(274).name("stone_pickaxe").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType STONE_AXE = IntItem.builder().id(275).name("stone_axe").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType DIAMOND_SWORD = IntItem.builder().id(276).name("diamond_sword").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType DIAMOND_SHOVEL = IntItem.builder().id(277).name("diamond_shovel").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType DIAMOND_PICKAXE = IntItem.builder().id(278).name("diamond_pickaxe").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType DIAMOND_AXE = IntItem.builder().id(279).name("diamond_axe").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    ...
    public static final ItemType GOLDEN_SWORD = IntItem.builder().id(283).name("golden_sword").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType GOLDEN_SHOVEL = IntItem.builder().id(284).name("golden_shovel").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType GOLDEN_PICKAXE = IntItem.builder().id(285).name("golden_pickaxe").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType GOLDEN_AXE = IntItem.builder().id(286).name("golden_axe").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    ...
    public static final ItemType LEATHER_CAP = IntItem.builder().id(298).name("leather_helmet").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType LEATHER_TUNIC = IntItem.builder().id(299).name("leather_chestplate").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType LEATHER_PANTS = IntItem.builder().id(300).name("leather_leggings").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType LEATHER_BOOTS = IntItem.builder().id(301).name("leather_boots").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType CHAIN_HELMET = IntItem.builder().id(302).name("chain_helmet").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType CHAIN_CHESTPLATE = IntItem.builder().id(303).name("chain_chestplate").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType CHAIN_LEGGINGS = IntItem.builder().id(304).name("chain_leggings").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType CHAIN_BOOTS = IntItem.builder().id(305).name("chain_boots").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType IRON_HELMET = IntItem.builder().id(306).name("iron_helmet").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType IRON_CHESTPLATE = IntItem.builder().id(307).name("iron_chestplate").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType IRON_LEGGINGS = IntItem.builder().id(308).name("iron_leggings").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType IRON_BOOTS = IntItem.builder().id(309).name("iron_boots").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType DIAMOND_HELMET = IntItem.builder().id(310).name("diamond_helmet").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType DIAMOND_CHESTPLATE = IntItem.builder().id(311).name("diamond_chestplate").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType DIAMOND_LEGGINGS = IntItem.builder().id(312).name("diamond_leggings").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType DIAMOND_BOOTS = IntItem.builder().id(313).name("diamond_boots").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType GOLDEN_HELMET = IntItem.builder().id(314).name("golden_helmet").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType GOLDEN_CHESTPLATE = IntItem.builder().id(315).name("golden_chestplate").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType GOLDEN_LEGGINGS = IntItem.builder().id(316).name("golden_leggings").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    public static final ItemType GOLDEN_BOOTS = IntItem.builder().id(317).name("golden_boots").maxStackSize(1).data(GenericDamageValue.class).defaultMetadata(ZERO).build();
    ...
    public static final ItemType DISC_CAT = IntItem.builder().id(500).name("record_cat").maxStackSize(1).build();
    public static final ItemType DISC_BLOCKS = IntItem.builder().id(500).name("record_blocks").maxStackSize(1).build();
    public static final ItemType DISC_CHIRP = IntItem.builder().id(500).name("record_chirp").maxStackSize(1).build();
    public static final ItemType DISC_FAR = IntItem.builder().id(500).name("record_far").maxStackSize(1).build();
    public static final ItemType DISC_MALL = IntItem.builder().id(500).name("record_mall").maxStackSize(1).build();
    public static final ItemType DISC_MELLOHI = IntItem.builder().id(500).name("record_mellohi").maxStackSize(1).build();
    public static final ItemType DISC_STAL = IntItem.builder().id(500).name("record_stal").maxStackSize(1).build();
    public static final ItemType DISC_STRAD = IntItem.builder().id(500).name("record_strad").maxStackSize(1).build();
    ...
    private static class IntItem  implements ItemType {
        ...
        public <C extends ItemComponent> boolean provides(Class<C> clazz) {
            return itemComponents.containsKey(clazz);
        }

        @Override
        public <C extends ItemComponent> Optional<C> get(Class<C> clazz) {
            Preconditions.checkNotNull(clazz, "clazz");
            return Optional.ofNullable((C) itemComponents.get(clazz));
        }
