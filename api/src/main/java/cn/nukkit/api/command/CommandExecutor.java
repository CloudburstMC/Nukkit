...
public interface CommandExecutor {
     ...
     * 可以使用{@link cn.nukkit.api.command.Command#testPermissionSilent}。<br>
     * If you want to test whether a command sender has the permission to execute a command,
     * you can use {@link cn.nukkit.api.command.Command#testPermissionSilent}.</p>
     *
     ...
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    boolean onCommand(CommandExecutorSource sender, Command command, String label, String[] args);
}
