 ...
 * <p>
 * <p>对于插件作者，我们建议让插件主类继承{@link JavaPlugin}类，而不是实现这个接口。<br>
 * For plugin developers: it's recommended to use {@link JavaPlugin} for an actual plugin
 * instead of implement this interface.</p>
 *
 * @author MagicDroidX(code) @ Nukkit Project
 * @author 粉鞋大妈(javadoc) @ Nukkit Project
 * @see JavaPlugin
 * @see com.nukkitx.api.plugin.PluginDescription
...
public interface Plugin {
     ...
     * <p>
     * <p>如果需要替换已存在的资源文件，建议使用{@link com.nukkitx.api.plugin.Plugin#saveResource(String, boolean)}<br>
     * If you need to REPLACE an existing resource file, it's recommended
     * to use {@link com.nukkitx.api.plugin.Plugin#saveResource(String, boolean)}.</p>
     *
     ...
     * @see com.nukkitx.api.plugin.Plugin#saveDefaultConfig
     * @see com.nukkitx.api.plugin.Plugin#saveResource(String, boolean)
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
     ...
     * which is normally named 'resources' and placed in plugin jar file, and copy it into data folder.</p>
     * <p>
     * <p>如果需要保存默认的资源文件，建议使用{@link com.nukkitx.api.plugin.Plugin#saveResource(String)}<br>
     * If you need to SAVE DEFAULT resource file, it's recommended
     * to use {@link com.nukkitx.api.plugin.Plugin#saveResource(String)}.</p>
     *
     * @param filename 要保存的资源文件名字。<br>The name of the resource file to save.
     * @param replace  是否替换目标文件。<br>if true, Nukkit will replace the target resource file.
     * @return 保存是否成功。<br>true if the saving action is successful.
     * @see com.nukkitx.api.plugin.Plugin#saveResource(String)
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    ...
    /**
     * 返回这个Nukkit插件配置文件的{@link com.nukkitx.api.util.Config}对象。<br>
     * The config file this Nukkit plugin as a {@link com.nukkitx.api.util.Config} object.
     * <p>
     ...
     * @see com.nukkitx.api.plugin.Plugin#getDataFolder
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    Config getConfig();
     ...
     *
     * @see com.nukkitx.api.plugin.Plugin#getDataFolder
     * @see com.nukkitx.api.plugin.Plugin#saveResource
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
     ...
     * Gets the NukkitServer which is running this plugin, and returns as a {@link Server} object.
     *
     * @see Server
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
     ...
     *
     * @see com.nukkitx.api.plugin.Plugin#getDescription
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    String getName();
    ...
    /**
     * 返回这个插件的日志记录器为{@link com.nukkitx.api.plugin.PluginLogger}对象。<br>
     * Returns the logger of this plugin as a {@link com.nukkitx.api.plugin.PluginLogger} object.
     * <p>
     * <p>使用日志记录器，你可以在控制台和日志文件输出信息。<br>
     * You can use a plugin logger to output messages to the console and log file.</p>
     *
     * @see com.nukkitx.api.plugin.PluginLogger
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    Logger getLogger();
