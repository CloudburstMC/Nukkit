...
public class BlockTypes {
    ...
    public static final BlockType BED = IntBlock.builder().name("bed").id(26).maxStackSize(1).diggable(true).transparent(true).solid(true).hardness(0.2f).floodable(true).metadataClass(SimpleDirectional.class).blockEntityClass(BedBlockEntity.class).build();
    ...
    public static final BlockType STONE_SLAB = IntBlock.builder().name("stone_slab").id(44).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).metadataClass(StoneSlab.class).build();
    ...
    public static final BlockType TORCH = IntBlock.builder().name("torch").id(50).maxStackSize(64).diggable(true).transparent(true).solid(true).emitLight(14).metadataClass(Directional.class).hardness(0f).floodable(true).build();
    ...
    public static final BlockType REDSTONE_TORCH = IntBlock.builder().name("unlit_redstone_torch").id(75).maxStackSize(64).diggable(true).transparent(true).solid(true).emitLight(7).metadataClass(Directional.class).hardness(0f).floodable(true).build();
    public static final BlockType REDSTONE_TORCH_ACTIVE = IntBlock.builder().name("lit_redstone_torch").id(76).maxStackSize(64).diggable(true).transparent(true).solid(true).emitLight(7).metadataClass(Directional.class).hardness(0f).floodable(true).build();
    ...
    public static final BlockType CACTUS = IntBlock.builder().name("cactus").id(81).maxStackSize(64).diggable(true).transparent(true).metadataClass(Growable.class).solid(true).hardness(0.4f).build();
    ...
    public static final BlockType SUGAR_CANE = IntBlock.builder().name("reeds").id(83).maxStackSize(64).diggable(true).transparent(true).solid(true).metadataClass(Growable.class).hardness(0f).floodable(true).build();
    ...
    public static final BlockType VINES = IntBlock.builder().name("vine").id(106).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.2f).metadataClass(Directional.class).floodable(true).build();
    public static final BlockType FENCE_GATE = IntBlock.builder().name("fence_gate").id(107).maxStackSize(64).diggable(true).transparent(true).solid(true).metadataClass(Door.class).hardness(2f).build();
    ...
    public static final BlockType TRIPWIRE_HOOK = IntBlock.builder().name("tripwire_hook").id(131).maxStackSize(64).diggable(true).transparent(true).solid(true).metadataClass(DirectionalPowerable.class).hardness(0f).floodable(true).build();
    ...
    public static final BlockType ANVIL = IntBlock.builder().name("anvil").id(145).maxStackSize(64).diggable(true).transparent(true).solid(true).metadataClass(Anvil.class).hardness(5f).build();
    ...
    public static final BlockType DOUBLE_RED_SANDSTONE_SLAB = IntBlock.builder().name("double_stone_slab2").id(181).maxStackSize(64).diggable(true).transparent(true).metadataClass(StoneSlab.class).solid(true).hardness(2f).build();
    public static final BlockType RED_SANDSTONE_SLAB = IntBlock.builder().name("stone_slab2").id(182).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).metadataClass(StoneSlab.class).build();
    public static final BlockType SPRUCE_FENCE_GATE = IntBlock.builder().name("spruce_fence_gate").id(183).maxStackSize(64).diggable(true).transparent(true).solid(true).metadataClass(Door.class).hardness(2f).build();
    public static final BlockType BIRCH_FENCE_GATE = IntBlock.builder().name("birch_fence_gate").id(184).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).metadataClass(Door.class).build();
    public static final BlockType JUNGLE_FENCE_GATE = IntBlock.builder().name("jungle_fence_gate").id(185).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).metadataClass(Door.class).build();
    public static final BlockType DARK_OAK_FENCE_GATE = IntBlock.builder().name("dark_oak_fence_gate").id(186).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).metadataClass(Door.class).build();
    public static final BlockType ACACIA_FENCE_GATE = IntBlock.builder().name("acacia_fence_gate").id(187).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).metadataClass(Door.class).build();
    ...
    public static final BlockType OBSERVER = IntBlock.builder().name("observer").id(251).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).metadataClass(Directional.class).build();
