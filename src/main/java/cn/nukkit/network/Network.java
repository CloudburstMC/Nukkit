...
public class Network {
    ...
    private void registerPackets() {
        ...
        this.registerPacket(ProtocolInfo.FULL_CHUNK_DATA_PACKET, WorldChunkPacket.class);
        ...
        this.registerPacket(ProtocolInfo.LEVEL_EVENT_PACKET, WorldEventPacket.class);
        this.registerPacket(ProtocolInfo.LEVEL_SOUND_EVENT_PACKET_V1, WorldSoundEventPacketV1.class);
        ...
        this.registerPacket(ProtocolInfo.LEVEL_SOUND_EVENT_PACKET_V2, WorldSoundEventPacket.class);
        ...
        this.registerPacket(ProtocolInfo.LEVEL_SOUND_EVENT_PACKET, WorldSoundEventPacket.class);
        this.registerPacket(ProtocolInfo.LEVEL_EVENT_GENERIC_PACKET, WorldEventGenericPacket.class);
