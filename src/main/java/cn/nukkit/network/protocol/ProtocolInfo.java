...
public interface ProtocolInfo {
    ...
    int CURRENT_PROTOCOL = Integer.valueOf("2168"); // DO NOT REMOVE BOXING

    List<Integer> SUPPORTED_PROTOCOLS = Ints.asList(CURRENT_PROTOCOL);

    String MINECRAFT_VERSION_NETWORK = "1.26.40";
    ...
    byte __INTERNAL__CLIENTBOUND_DATA_DRIVEN_UI_SHOW_SCREEN_PACKET = (byte) 233;
    byte __INTERNAL__CLIENTBOUND_DATA_DRIVEN_UI_CLOSE_SCREEN_PACKET = (byte) 234;
    byte __INTERNAL__CLIENTBOUND_DATA_DRIVEN_UI_RELOAD_PACKET = (byte) 235;
    ...
    byte __INTERNAL__SERVER_STORE_INFO_PACKET = (byte) 246;
