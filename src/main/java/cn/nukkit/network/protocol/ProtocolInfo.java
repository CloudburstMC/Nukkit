...
public interface ProtocolInfo {
    ...
    int CURRENT_PROTOCOL = Integer.valueOf("860"); // DO NOT REMOVE BOXING

    List<Integer> SUPPORTED_PROTOCOLS = Ints.asList(859, CURRENT_PROTOCOL);

    String MINECRAFT_VERSION_NETWORK = "1.21.124";
