...
public interface ProtocolInfo {
    ...
    int CURRENT_PROTOCOL = Integer.valueOf("440"); // DO NOT REMOVE BOXING
    ...
    byte STRUCTURE_TEMPLATE_DATA_REQUEST_PACKET = (byte) 0x84;
    byte STRUCTURE_TEMPLATE_DATA_RESPONSE_PACKET = (byte) 0x85;
