 ...
 * Nukkit Project
 */
public interface ProtocolInfo113 extends ProtocolInfo {

    /**
     * 1.1.x Minecraft: PE protocol version
     */
    int PROTOCOL = 113;
    String MINECRAFT_VERSION = "v1.1.x";
    ...
    byte INVENTORY_CONTENT_PACKET = 0x34;
    ...
    byte COMMAND_REQUEST_PACKET = 0x4f;
