...
public class LevelEventPacket extends DataPacket {
    ...
    @PowerNukkitOnly @Since("FUTURE") public static final int EVENT_SOUND_POINTED_DRIPSTONE_LAND = 1064;
    @PowerNukkitOnly @Since("FUTURE") public static final int EVENT_SOUND_DYE_USED = 1065;
    @PowerNukkitOnly @Since("FUTURE") public static final int EVENT_SOUND_INK_SACE_USED = 1066;
    ...
    @PowerNukkitOnly @Since("FUTURE") public static final int EVENT_PARTICLE_VIBRATION_SIGNAL = 2027;
    @PowerNukkitOnly @Since("FUTURE") public static final int EVENT_PARTICLE_DRIPSTONE_DRIP = 2028;
    @PowerNukkitOnly @Since("FUTURE") public static final int EVENT_PARTICLE_FIZZ_EFFECT = 2029;
    @PowerNukkitOnly @Since("FUTURE") public static final int EVENT_PARTICLE_WAX_ON = 2030;
    @PowerNukkitOnly @Since("FUTURE") public static final int EVENT_PARTICLE_WAX_OFF = 2031;
    @PowerNukkitOnly @Since("FUTURE") public static final int EVENT_PARTICLE_SCRAPE = 2032;
    @PowerNukkitOnly @Since("FUTURE") public static final int EVENT_PARTICLE_ELECTRIC_SPARK = 2033;
    ...
    @Since("FUTURE") @PowerNukkitOnly public static final int EVENT_SOUND_CAULDRON_FILL_POWDER_SNOW = 3514;
    @Since("FUTURE") @PowerNukkitOnly public static final int EVENT_SOUND_CAULDRON_TAKE_POWDER_SNOW = 3515;
