...
import cn.nukkit.world.format.generic.BaseRegionLoader;
...
public class Anvil extends BaseLevelProvider {
    ...
    public Anvil(World level, String path) throws IOException {
        super(level, path);
    }
    ...
    public AsyncTask requestChunkTask(int x, int z) throws ChunkException {
        ...
        int count = 0;
        cn.nukkit.world.format.ChunkSection[] sections = chunk.getSections();
        ...
        this.getWorld().chunkRequestCallback(timestamp, x, z, count, stream.getBuffer());
