 ...
 * Nukkit Project
 */
public abstract class BaseLevelProvider implements WorldProvider {
    ...
    public BaseLevelProvider(World level, String path) throws IOException {
        this.level = level;
        this.path = path;
    ...
    public boolean isChunkLoaded(int X, int Z) {
        return isChunkLoaded(World.chunkHash(X, Z));
    }
