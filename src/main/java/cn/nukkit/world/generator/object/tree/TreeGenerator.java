...
public abstract class TreeGenerator extends cn.nukkit.world.generator.object.BasicGenerator {
    ...
    public void generateSaplings(World level, Random random, Vector3 pos) {
    }
