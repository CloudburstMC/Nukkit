...
public class PopulatorSugarcane extends PopulatorSurfaceBlock {
    ...
    private boolean findWater(int x, int y, int z, World level) {
        int count = 0;
    ...
    protected boolean canStay(int x, int y, int z, FullChunk chunk) {
        return EnsureCover.ensureCover(x, y, z, chunk) && (EnsureGrassBelow.ensureGrassBelow(x, y, z, chunk) || EnsureBelow.ensureBelow(x, y, z, SAND, chunk)) && findWater(x, y - 1, z, chunk.getProvider().getWorld());
    }
