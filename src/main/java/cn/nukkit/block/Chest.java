...
public class Chest extends Transparent{
    ...
    public boolean place(Item item, Block block, Block target, int face, double fx, double fy, double fz, Player player) {
        ...
        if(chest instanceof cn.nukkit.tile.Chest && tile instanceof cn.nukkit.tile.Chest) {
        ...
        if(player instanceof  Player) {
            ...
            if(t instanceof cn.nukkit.tile.Chest) {
                ...
                CompoundTag nbt = new CompoundTag("")
                        ...
                        .putInt("y", (int) this.y)
                        .putInt("z", (int) this.z);
                chest = (cn.nukkit.tile.Chest) (Tile.createTile("Chest", this.getLevel().getChunk((int) (this.x) >> 4, (int) (this.z) >> 4), nbt));
            }
