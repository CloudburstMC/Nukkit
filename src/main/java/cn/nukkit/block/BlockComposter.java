...
public class BlockComposter extends BlockTransparentMeta implements ItemID {
    ...
    static {
        ...
        registerBlocks(30, GRASS, LEAVES, LEAVES2, SAPLINGS, SEAGRASS, SMALL_DRIPLEAF);
        ...
        registerBlocks(85, FLOWERING_AZALEA, HAY_BALE, BROWN_MUSHROOM_BLOCK, RED_MUSHROOM_BLOCK, BLOCK_NETHER_WART_BLOCK, WARPED_WART_BLOCK);
