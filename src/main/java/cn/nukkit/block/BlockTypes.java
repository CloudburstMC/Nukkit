...
public class BlockTypes {
    ...
    public static final BlockType STONE_SLAB3 = register("minecraft:stone_slab3", BlockID.STONE_SLAB3);
    ...
    public static final BlockType STONE_SLAB4 = register("minecraft:stone_slab4", BlockID.STONE_SLAB4);
    ...
    public static final BlockType PISTON_HEAD_STICKY = register("minecraft:stickyPistonArmCollision", BlockID.PISTON_HEAD_STICKY);
    ...
    public static final BlockType CRAFTER = register("minecraft:crafter", BlockID.CRAFTER);
    public static final BlockType VAULT = register("minecraft:vault", BlockID.VAULT);
    public static final BlockType TRIAL_SPAWNER = register("minecraft:trial_spawner", BlockID.TRIAL_SPAWNER);
    public static final BlockType HEAVY_CORE = register("minecraft:heavy_core", BlockID.HEAVY_CORE);
    ...
    public static final BlockType MANGROVE_DOOR_BLOCK = register("minecraft:item.mangrove_door", BlockID.MANGROVE_DOOR_BLOCK);
    ...
    public static final BlockType OAK_HANGING_SIGN = register("minecraft:oak_hanging_sign", BlockID.OAK_HANGING_SIGN);
    public static final BlockType SPRUCE_HANGING_SIGN = register("minecraft:spruce_hanging_sign", BlockID.SPRUCE_HANGING_SIGN);
    public static final BlockType BIRCH_HANGING_SIGN = register("minecraft:birch_hanging_sign", BlockID.BIRCH_HANGING_SIGN);
    public static final BlockType JUNGLE_HANGING_SIGN = register("minecraft:jungle_hanging_sign", BlockID.JUNGLE_HANGING_SIGN);
    public static final BlockType ACACIA_HANGING_SIGN = register("minecraft:acacia_hanging_sign", BlockID.ACACIA_HANGING_SIGN);
    public static final BlockType DARK_OAK_HANGING_SIGN = register("minecraft:dark_oak_hanging_sign", BlockID.DARK_OAK_HANGING_SIGN);
    public static final BlockType CRIMSON_HANGING_SIGN = register("minecraft:crimson_hanging_sign", BlockID.CRIMSON_HANGING_SIGN);
    public static final BlockType WARPED_HANGING_SIGN = register("minecraft:warped_hanging_sign", BlockID.WARPED_HANGING_SIGN);
    public static final BlockType MANGROVE_HANGING_SIGN = register("minecraft:mangrove_hanging_sign", BlockID.MANGROVE_HANGING_SIGN);
    public static final BlockType BAMBOO_MOSAIC = register("minecraft:bamboo_mosaic", BlockID.BAMBOO_MOSAIC);
    public static final BlockType BAMBOO_PLANKS = register("minecraft:bamboo_planks", BlockID.BAMBOO_PLANKS);
    public static final BlockType BAMBOO_BUTTON = register("minecraft:bamboo_button", BlockID.BAMBOO_BUTTON);
    public static final BlockType BAMBOO_STAIRS = register("minecraft:bamboo_stairs", BlockID.BAMBOO_STAIRS);
    public static final BlockType BAMBOO_SLAB = register("minecraft:bamboo_slab", BlockID.BAMBOO_SLAB);
    public static final BlockType BAMBOO_PRESSURE_PLATE = register("minecraft:bamboo_pressure_plate", BlockID.BAMBOO_PRESSURE_PLATE);
    public static final BlockType BAMBOO_FENCE = register("minecraft:bamboo_fence", BlockID.BAMBOO_FENCE);
    public static final BlockType BAMBOO_FENCE_GATE = register("minecraft:bamboo_fence_gate", BlockID.BAMBOO_FENCE_GATE);
    public static final BlockType BAMBOO_DOOR_BLOCK = register("minecraft:bamboo_door_block", BlockID.BAMBOO_DOOR_BLOCK);
    public static final BlockType BAMBOO_STANDING_SIGN = register("minecraft:bamboo_standing_sign", BlockID.BAMBOO_STANDING_SIGN);
    public static final BlockType BAMBOO_WALL_SIGN = register("minecraft:bamboo_wall_sign", BlockID.BAMBOO_WALL_SIGN);
    public static final BlockType BAMBOO_TRAPDOOR = register("minecraft:bamboo_trapdoor", BlockID.BAMBOO_TRAPDOOR);
    public static final BlockType BAMBOO_DOUBLE_SLAB = register("minecraft:bamboo_double_slab", BlockID.BAMBOO_DOUBLE_SLAB);
    public static final BlockType BAMBOO_HANGING_SIGN = register("minecraft:bamboo_hanging_sign", BlockID.BAMBOO_HANGING_SIGN);
    public static final BlockType BAMBOO_MOSAIC_STAIRS = register("minecraft:bamboo_mosaic_stairs", BlockID.BAMBOO_MOSAIC_STAIRS);
    public static final BlockType BAMBOO_MOSAIC_SLAB = register("minecraft:bamboo_mosaic_slab", BlockID.BAMBOO_MOSAIC_SLAB);
    public static final BlockType BAMBOO_MOSAIC_DOUBLE_SLAB = register("minecraft:bamboo_mosaic_double_slab", BlockID.BAMBOO_MOSAIC_DOUBLE_SLAB);
    public static final BlockType CHISELED_BOOKSHELF = register("minecraft:chiseled_bookshelf", BlockID.CHISELED_BOOKSHELF);
    public static final BlockType BAMBOO_BLOCK = register("minecraft:bamboo_block", BlockID.BAMBOO_BLOCK);
    public static final BlockType STRIPPED_BAMBOO_BLOCK = register("minecraft:stripped_bamboo_block", BlockID.STRIPPED_BAMBOO_BLOCK);
    public static final BlockType SUSPICIOUS_SAND = register("minecraft:suspicious_sand", BlockID.SUSPICIOUS_SAND);
    public static final BlockType CHERRY_BUTTON = register("minecraft:cherry_button", BlockID.CHERRY_BUTTON);
    public static final BlockType CHERRY_DOOR_BLOCK = register("minecraft:cherry_door_block", BlockID.CHERRY_DOOR_BLOCK);
    public static final BlockType CHERRY_FENCE = register("minecraft:cherry_fence", BlockID.CHERRY_FENCE);
    public static final BlockType CHERRY_FENCE_GATE = register("minecraft:cherry_fence_gate", BlockID.CHERRY_FENCE_GATE);
    public static final BlockType CHERRY_HANGING_SIGN = register("minecraft:cherry_hanging_sign", BlockID.CHERRY_HANGING_SIGN);
    public static final BlockType STRIPPED_CHERRY_LOG = register("minecraft:stripped_cherry_log", BlockID.STRIPPED_CHERRY_LOG);
    public static final BlockType CHERRY_LOG = register("minecraft:cherry_log", BlockID.CHERRY_LOG);
    public static final BlockType CHERRY_PLANKS = register("minecraft:cherry_planks", BlockID.CHERRY_PLANKS);
    public static final BlockType CHERRY_PRESSURE_PLATE = register("minecraft:cherry_pressure_plate", BlockID.CHERRY_PRESSURE_PLATE);
    public static final BlockType CHERRY_SLAB = register("minecraft:cherry_slab", BlockID.CHERRY_SLAB);
    public static final BlockType CHERRY_DOUBLE_SLAB = register("minecraft:cherry_double_slab", BlockID.CHERRY_DOUBLE_SLAB);
    public static final BlockType CHERRY_STAIRS = register("minecraft:cherry_stairs", BlockID.CHERRY_STAIRS);
    public static final BlockType CHERRY_STANDING_SIGN = register("minecraft:cherry_standing_sign", BlockID.CHERRY_STANDING_SIGN);
    public static final BlockType CHERRY_TRAPDOOR = register("minecraft:cherry_trapdoor", BlockID.CHERRY_TRAPDOOR);
    public static final BlockType CHERRY_WALL_SIGN = register("minecraft:cherry_wall_sign", BlockID.CHERRY_WALL_SIGN);
    public static final BlockType STRIPPED_CHERRY_WOOD = register("minecraft:stripped_cherry_wood", BlockID.STRIPPED_CHERRY_WOOD);
    public static final BlockType CHERRY_WOOD = register("minecraft:cherry_wood", BlockID.CHERRY_WOOD);
    public static final BlockType CHERRY_SAPLING = register("minecraft:cherry_sapling", BlockID.CHERRY_SAPLING);
    public static final BlockType CHERRY_LEAVES = register("minecraft:cherry_leaves", BlockID.CHERRY_LEAVES);
    public static final BlockType PINK_PETALS = register("minecraft:pink_petals", BlockID.PINK_PETALS);
    public static final BlockType DECORATED_POT = register("minecraft:decorated_pot", BlockID.DECORATED_POT);
    public static final BlockType TORCHFLOWER_CROP = register("minecraft:torchflower_crop", BlockID.TORCHFLOWER_CROP);
    public static final BlockType TORCHFLOWER = register("minecraft:torchflower", BlockID.TORCHFLOWER);
    public static final BlockType SUSPICIOUS_GRAVEL = register("minecraft:suspicious_gravel", BlockID.SUSPICIOUS_GRAVEL);
    public static final BlockType PITCHER_CROP = register("minecraft:pitcher_crop", BlockID.PITCHER_CROP);
    public static final BlockType CALIBRATED_SCULK_SENSOR = register("minecraft:calibrated_sculk_sensor", BlockID.CALIBRATED_SCULK_SENSOR);
    public static final BlockType SNIFFER_EGG = register("minecraft:sniffer_egg", BlockID.SNIFFER_EGG);
    public static final BlockType PITCHER_PLANT = register("minecraft:pitcher_plant", BlockID.PITCHER_PLANT);
    public static final BlockType TUFF_SLAB = register("minecraft:tuff_slab", BlockID.TUFF_SLAB);
    public static final BlockType TUFF_DOUBLE_SLAB = register("minecraft:tuff_double_slab", BlockID.TUFF_DOUBLE_SLAB);
    public static final BlockType TUFF_STAIRS = register("minecraft:tuff_stairs", BlockID.TUFF_STAIRS);
    public static final BlockType TUFF_WALL = register("minecraft:tuff_wall", BlockID.TUFF_WALL);
    public static final BlockType POLISHED_TUFF = register("minecraft:polished_tuff", BlockID.POLISHED_TUFF);
    public static final BlockType POLISHED_TUFF_SLAB = register("minecraft:polished_tuff_slab", BlockID.POLISHED_TUFF_SLAB);
    public static final BlockType POLISHED_TUFF_DOUBLE_SLAB = register("minecraft:polished_tuff_double_slab", BlockID.POLISHED_TUFF_DOUBLE_SLAB);
    public static final BlockType POLISHED_TUFF_STAIRS = register("minecraft:polished_tuff_stairs", BlockID.POLISHED_TUFF_STAIRS);
    public static final BlockType POLISHED_TUFF_WALL = register("minecraft:polished_tuff_wall", BlockID.POLISHED_TUFF_WALL);
    public static final BlockType CHISELED_TUFF = register("minecraft:chiseled_tuff", BlockID.CHISELED_TUFF);
    public static final BlockType TUFF_BRICKS = register("minecraft:tuff_bricks", BlockID.TUFF_BRICKS);
    public static final BlockType TUFF_BRICK_SLAB = register("minecraft:tuff_brick_slab", BlockID.TUFF_BRICK_SLAB);
    public static final BlockType TUFF_BRICK_DOUBLE_SLAB = register("minecraft:tuff_brick_double_slab", BlockID.TUFF_BRICK_DOUBLE_SLAB);
    public static final BlockType TUFF_BRICK_STAIRS = register("minecraft:tuff_brick_stairs", BlockID.TUFF_BRICK_STAIRS);
    public static final BlockType TUFF_BRICK_WALL = register("minecraft:tuff_brick_wall", BlockID.TUFF_BRICK_WALL);
    public static final BlockType CHISELED_TUFF_BRICKS = register("minecraft:chiseled_tuff_bricks", BlockID.CHISELED_TUFF_BRICKS);
    public static final BlockType CHISELED_COPPER = register("minecraft:chiseled_copper", BlockID.CHISELED_COPPER);
    public static final BlockType EXPOSED_CHISELED_COPPER = register("minecraft:exposed_chiseled_copper", BlockID.EXPOSED_CHISELED_COPPER);
    public static final BlockType WEATHERED_CHISELED_COPPER = register("minecraft:weathered_chiseled_copper", BlockID.WEATHERED_CHISELED_COPPER);
    public static final BlockType OXIDIZED_CHISELED_COPPER = register("minecraft:oxidized_chiseled_copper", BlockID.OXIDIZED_CHISELED_COPPER);
    public static final BlockType WAXED_CHISELED_COPPER = register("minecraft:waxed_chiseled_copper", BlockID.WAXED_CHISELED_COPPER);
    public static final BlockType WAXED_EXPOSED_CHISELED_COPPER = register("minecraft:waxed_exposed_chiseled_copper", BlockID.WAXED_EXPOSED_CHISELED_COPPER);
    public static final BlockType WAXED_OXIDIZED_CHISELED_COPPER = register("minecraft:waxed_oxidized_chiseled_copper", BlockID.WAXED_OXIDIZED_CHISELED_COPPER);
    public static final BlockType WAXED_WEATHERED_CHISELED_COPPER = register("minecraft:waxed_weathered_chiseled_copper", BlockID.WAXED_WEATHERED_CHISELED_COPPER);
    public static final BlockType COPPER_GRATE = register("minecraft:copper_grate", BlockID.COPPER_GRATE);
    public static final BlockType EXPOSED_COPPER_GRATE = register("minecraft:exposed_copper_grate", BlockID.EXPOSED_COPPER_GRATE);
    public static final BlockType WEATHERED_COPPER_GRATE = register("minecraft:weathered_copper_grate", BlockID.WEATHERED_COPPER_GRATE);
    public static final BlockType OXIDIZED_COPPER_GRATE = register("minecraft:oxidized_copper_grate", BlockID.OXIDIZED_COPPER_GRATE);
    public static final BlockType WAXED_COPPER_GRATE = register("minecraft:waxed_copper_grate", BlockID.WAXED_COPPER_GRATE);
    public static final BlockType WAXED_EXPOSED_COPPER_GRATE = register("minecraft:waxed_exposed_copper_grate", BlockID.WAXED_EXPOSED_COPPER_GRATE);
    public static final BlockType WAXED_WEATHERED_COPPER_GRATE = register("minecraft:waxed_weathered_copper_grate", BlockID.WAXED_WEATHERED_COPPER_GRATE);
    public static final BlockType WAXED_OXIDIZED_COPPER_GRATE = register("minecraft:waxed_oxidized_copper_grate", BlockID.WAXED_OXIDIZED_COPPER_GRATE);
    public static final BlockType COPPER_BULB = register("minecraft:copper_bulb", BlockID.COPPER_BULB);
    public static final BlockType EXPOSED_COPPER_BULB = register("minecraft:exposed_copper_bulb", BlockID.EXPOSED_COPPER_BULB);
    public static final BlockType WEATHERED_COPPER_BULB = register("minecraft:weathered_copper_bulb", BlockID.WEATHERED_COPPER_BULB);
    public static final BlockType OXIDIZED_COPPER_BULB = register("minecraft:oxidized_copper_bulb", BlockID.OXIDIZED_COPPER_BULB);
    public static final BlockType WAXED_COPPER_BULB = register("minecraft:waxed_copper_bulb", BlockID.WAXED_COPPER_BULB);
    public static final BlockType WAXED_EXPOSED_COPPER_BULB = register("minecraft:waxed_exposed_copper_bulb", BlockID.WAXED_EXPOSED_COPPER_BULB);
    public static final BlockType WAXED_WEATHERED_COPPER_BULB = register("minecraft:waxed_weathered_copper_bulb", BlockID.WAXED_WEATHERED_COPPER_BULB);
    public static final BlockType WAXED_OXIDIZED_COPPER_BULB = register("minecraft:waxed_oxidized_copper_bulb", BlockID.WAXED_OXIDIZED_COPPER_BULB);
    public static final BlockType COPPER_DOOR_BLOCK = register("minecraft:copper_door", BlockID.COPPER_DOOR_BLOCK);
    public static final BlockType EXPOSED_COPPER_DOOR_BLOCK = register("minecraft:exposed_copper_door", BlockID.EXPOSED_COPPER_DOOR_BLOCK);
    public static final BlockType WEATHERED_COPPER_DOOR_BLOCK = register("minecraft:weathered_copper_door", BlockID.WEATHERED_COPPER_DOOR_BLOCK);
    public static final BlockType OXIDIZED_COPPER_DOOR_BLOCK = register("minecraft:oxidized_copper_door", BlockID.OXIDIZED_COPPER_DOOR_BLOCK);
    public static final BlockType WAXED_COPPER_DOOR_BLOCK = register("minecraft:waxed_copper_door", BlockID.WAXED_COPPER_DOOR_BLOCK);
    public static final BlockType WAXED_EXPOSED_COPPER_DOOR_BLOCK = register("minecraft:waxed_exposed_copper_door", BlockID.WAXED_EXPOSED_COPPER_DOOR_BLOCK);
    public static final BlockType WAXED_WEATHERED_COPPER_DOOR_BLOCK = register("minecraft:waxed_weathered_copper_door", BlockID.WAXED_WEATHERED_COPPER_DOOR_BLOCK);
    public static final BlockType WAXED_OXIDIZED_COPPER_DOOR_BLOCK = register("minecraft:waxed_oxidized_copper_door", BlockID.WAXED_OXIDIZED_COPPER_DOOR_BLOCK);
    public static final BlockType COPPER_TRAPDOOR = register("minecraft:copper_trapdoor", BlockID.COPPER_TRAPDOOR);
    public static final BlockType EXPOSED_COPPER_TRAPDOOR = register("minecraft:exposed_copper_trapdoor", BlockID.EXPOSED_COPPER_TRAPDOOR);
    public static final BlockType WEATHERED_COPPER_TRAPDOOR = register("minecraft:weathered_copper_trapdoor", BlockID.WEATHERED_COPPER_TRAPDOOR);
    public static final BlockType OXIDIZED_COPPER_TRAPDOOR = register("minecraft:oxidized_copper_trapdoor", BlockID.OXIDIZED_COPPER_TRAPDOOR);
    public static final BlockType WAXED_COPPER_TRAPDOOR = register("minecraft:waxed_copper_trapdoor", BlockID.WAXED_COPPER_TRAPDOOR);
    public static final BlockType WAXED_EXPOSED_COPPER_TRAPDOOR = register("minecraft:waxed_exposed_copper_trapdoor", BlockID.WAXED_EXPOSED_COPPER_TRAPDOOR);
