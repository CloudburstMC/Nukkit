    ...
    public boolean onActivate(Item item, Player player) {
        if (player != null) {
            ...
            if (t instanceof BlockEntityCommand) {
                ...
                CompoundTag nbt = new CompoundTag().putString("id", BlockEntity.COMMAND_BLOCK).putInt("x", (int) this.x).putInt("y", (int) this.y).putInt("z", (int) this.z).putString("Command", "").putInt("type", 0).putInt("redstone", 0).putInt("conditional", 0);
