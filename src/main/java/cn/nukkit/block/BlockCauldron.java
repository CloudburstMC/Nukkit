    ...
    public boolean onActivate(Item item, Player player) {
        ...
        switch (item.getId()) {
            case Item.BUCKET:
                if (item.getDamage() == 0) {//empty bucket
                    ...
                    if (!ev.isCancelled()) {
                        ...
                        this.getLevel().addSound(this.add(0.5, 1, 0.5), Sound.RANDOM_SPLASH);
                    }
                    ...
                    if (!ev.isCancelled()) {
                        ...
                        if (cauldron.hasPotion()) {//if has potion
                            ...
                            cauldron.clearCustomColor();
                            this.level.setBlock(this, this, true);
                            this.level.addSound(this.add(0.5, 0.5, 0.5), Sound.RANDOM_EXPLODE);
                        } else {
                            this.meta = 6;//fill
                            cauldron.clearCustomColor();
                            this.level.setBlock(this, this, true);
                            this.level.addSound(this.add(0.5, 1, 0.5), Sound.RANDOM_SPLASH);
                        }
                        //this.update();
                    }
                }
            ...
            case Item.POTION:
                ...
                this.level.addSound(this.add(0.5, 0.5, 0.5), Sound.RANDOM_SPLASH);
                break;
