...
public interface ItemID {
    ...
    int BAMBOO_CHEST_RAFT = 645;
    int CHERRY_CHEST_BOAT = 646;
    int ECHO_SHARD = 647;
    int RECOVERY_COMPASS = 648;
    int NETHERITE_UPGRADE_SMITHING_TEMPLATE = 649;
    ...
    int COAST_ARMOR_TRIM_SMITHING_TEMPLATE = 702;
    int DUNE_ARMOR_TRIM_SMITHING_TEMPLATE = 703;
    int EYE_ARMOR_TRIM_SMITHING_TEMPLATE = 704;
    int HOST_ARMOR_TRIM_SMITHING_TEMPLATE = 705;
    int RAISER_ARMOR_TRIM_SMITHING_TEMPLATE = 706;
    int RIB_ARMOR_TRIM_SMITHING_TEMPLATE = 707;
    int SENTRY_ARMOR_TRIM_SMITHING_TEMPLATE = 708;
    int SHAPER_ARMOR_TRIM_SMITHING_TEMPLATE = 709;
    int SILENCE_ARMOR_TRIM_SMITHING_TEMPLATE = 710;
    int SNOUT_ARMOR_TRIM_SMITHING_TEMPLATE = 711;
    int SPIRE_ARMOR_TRIM_SMITHING_TEMPLATE = 712;
    int TIDE_ARMOR_TRIM_SMITHING_TEMPLATE = 713;
    int VEX_ARMOR_TRIM_SMITHING_TEMPLATE = 714;
    int WARD_ARMOR_TRIM_SMITHING_TEMPLATE = 715;
    int WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE = 716;
    int WILD_ARMOR_TRIM_SMITHING_TEMPLATE = 717;
    int BOLT_ARMOR_TRIM_SMITHING_TEMPLATE = 718;
    int FLOW_ARMOR_TRIM_SMITHING_TEMPLATE = 719;
    int CAMPFIRE = 720;
    //
    ...
    int ANGLER_POTTERY_SHERD = 774;
    int ARCHER_POTTERY_SHERD = 775;
    int ARMS_UP_POTTERY_SHERD = 776;
    int BLADE_POTTERY_SHERD = 777;
    int BREWER_POTTERY_SHERD = 778;
    int BURN_POTTERY_SHERD = 779;
    int DANGER_POTTERY_SHERD = 780;
    int EXPLORER_POTTERY_SHERD = 781;
    int FLOW_POTTERY_SHERD = 782;
    int FRIEND_POTTERY_SHERD = 783;
    int GUSTER_POTTERY_SHERD = 784;
    int HEART_POTTERY_SHERD = 785;
    int HEARTBREAK_POTTERY_SHERD = 786;
    int HOWL_POTTERY_SHERD = 787;
    int MINER_POTTERY_SHERD = 788;
    int MOURNER_POTTERY_SHERD = 789;
    int PLENTY_POTTERY_SHERD = 790;
    int PRIZE_POTTERY_SHERD = 791;
    int SCRAPE_POTTERY_SHERD = 792;
    int SHEAF_POTTERY_SHERD = 793;
