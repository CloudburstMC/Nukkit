 ...
 */
public class Villager extends Creature<Villager> implements EntityNPC, EntityAgeable {
    ...
    public Villager(EntityType<Villager> type, Chunk chunk, CompoundTag nbt) {
