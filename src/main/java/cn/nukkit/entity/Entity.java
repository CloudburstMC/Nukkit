...
public abstract class Entity extends Location implements Metadatable {
    ...
    public static final int DATA_COLOR = dynamic(3), DATA_COLOUR = 3; //byte
    ...
    @Since("1.2.0.0-PN") public static final int DATA_FISH_X = dynamic(33);
    @Since("1.2.0.0-PN") public static final int DATA_FISH_Z = dynamic(34);
    @Since("1.2.0.0-PN") public static final int DATA_FISH_ANGLE = dynamic(35);
    ...
    public static final int DATA_PUFFERFISH_SIZE = dynamic(86);
    @Since("1.2.0.0-PN") public static final int DATA_BUBBLE_TIME = dynamic(87);
    @Since("1.2.0.0-PN") public static final int DATA_AGENT = dynamic(88);
    ...
    @Since("1.2.0.0-PN") public static final int DATA_EATING_COUNTER = dynamic(91);
    public static final int DATA_FLAGS_EXTENDED = dynamic(92);
    ...
    @Since("1.2.0.0-PN") public static final int DATA_DURATION = dynamic(95);
    @Since("1.2.0.0-PN") public static final int DATA_SPAWN_TIME = dynamic(96);
    @Since("1.2.0.0-PN") public static final int DATA_CHANGE_RATE = dynamic(97);
    @Since("1.2.0.0-PN") public static final int DATA_CHANGE_ON_PICKUP = dynamic(98);
    @Since("1.2.0.0-PN") public static final int DATA_PICKUP_COUNT = dynamic(99);
    @Since("1.2.0.0-PN") public static final int DATA_INTERACT_TEXT = dynamic(100);
    public static final int DATA_TRADE_TIER = dynamic(101); // int
    public static final int DATA_MAX_TRADE_TIER = dynamic(102); // int
    @Since("1.2.0.0-PN") public static final int DATA_TRADE_EXPERIENCE = dynamic(103);
    ...
    @Since("1.2.0.0-PN") public static final int DATA_COMMAND_BLOCK_TICK_DELAY = dynamic(106);
    @Since("1.2.0.0-PN") public static final int DATA_COMMAND_BLOCK_EXECUTE_ON_FIRST_TICK = dynamic(107);
    @Since("1.2.0.0-PN") public static final int DATA_AMBIENT_SOUND_INTERVAL = dynamic(108);
    @Since("1.3.0.0-PN") public static final int DATA_AMBIENT_SOUND_INTERVAL_RANGE = dynamic(109);
    @Since("1.2.0.0-PN") public static final int DATA_AMBIENT_SOUND_EVENT_NAME = dynamic(110);
    @Since("1.2.0.0-PN") public static final int DATA_FALL_DAMAGE_MULTIPLIER = dynamic(111);
    @Since("1.2.0.0-PN") public static final int DATA_NAME_RAW_TEXT = dynamic(112);
    @Since("1.2.0.0-PN") public static final int DATA_CAN_RIDE_TARGET = dynamic(113);
    @Since("1.3.0.0-PN") public static final int DATA_LOW_TIER_CURED_DISCOUNT = dynamic(114);
    @Since("1.3.0.0-PN") public static final int DATA_HIGH_TIER_CURED_DISCOUNT = dynamic(115);
    @Since("1.3.0.0-PN") public static final int DATA_NEARBY_CURED_DISCOUNT = dynamic(116);
    @Since("1.3.0.0-PN") public static final int DATA_NEARBY_CURED_DISCOUNT_TIMESTAMP = dynamic(117);
    @Since("1.3.0.0-PN") public static final int DATA_HITBOX = dynamic(118);
    @Since("1.3.0.0-PN") public static final int DATA_IS_BUOYANT = dynamic(119);
    @Since("1.3.0.0-PN") public static final int DATA_BUOYANCY_DATA = dynamic(120);
