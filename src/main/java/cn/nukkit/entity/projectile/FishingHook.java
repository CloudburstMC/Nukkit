...
public class FishingHook extends Projectile {
    ...
    public FishingHook(EntityType<FishingHook> type, Chunk chunk, CompoundTag nbt) {
        this(type, chunk, nbt, null);
    }

    public FishingHook(EntityType<FishingHook> type, Chunk chunk, CompoundTag nbt, Entity shootingEntity) {
