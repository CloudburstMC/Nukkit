 ...
 */
public class ThrownTrident extends Projectile {
    ...
    public ThrownTrident(EntityType<ThrownTrident> type, Chunk chunk, CompoundTag nbt) {
        this(type, chunk, nbt, null);
    }

    public ThrownTrident(EntityType<ThrownTrident> type, Chunk chunk, CompoundTag nbt, Entity shootingEntity) {
        this(type, chunk, nbt, shootingEntity, false);
    }

    public ThrownTrident(EntityType<ThrownTrident> type, Chunk chunk, CompoundTag nbt, Entity shootingEntity, boolean critical) {
    ...
    private static ThrownTrident create(Entity source) {
        ...
        return new ThrownTrident(EntityTypes.THROWN_TRIDENT, chunk, nbt, source);
    }
    ...
    public void onCollideWithEntity(Entity entity) {
        ...
        this.close();
        ThrownTrident newTrident = create(this);
