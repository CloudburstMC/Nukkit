 ...
 * @author xtypr
 */
public class SplashPotion extends Projectile {

    public static final int DATA_POTION_ID = 37;

    public int potionId;

    public SplashPotion(EntityType<SplashPotion> type, Chunk chunk, CompoundTag nbt) {
        super(type, chunk, nbt);
    }

    public SplashPotion(EntityType<SplashPotion> type, Chunk chunk, CompoundTag nbt, Entity shootingEntity) {
