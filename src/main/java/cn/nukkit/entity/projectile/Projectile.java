...
public abstract class Projectile extends Entity {
    ...
    public Projectile(EntityType<?> type, Chunk chunk, CompoundTag nbt) {
        this(type, chunk, nbt, null);
    }

    public Projectile(EntityType<?> type, Chunk chunk, CompoundTag nbt, Entity shootingEntity) {
    ...
    public boolean canCollideWith(Entity entity) {
        return (entity instanceof LivingEntity || entity instanceof EnderCrystal) && !this.onGround;
    }
