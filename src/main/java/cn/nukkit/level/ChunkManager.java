...
public interface ChunkManager {
    ...
    default int getBlockDataAt(Vector3i position) {
        return getBlockDataAt(position.getX(), position.getY(), position.getZ());
    }
    ...
    default int getBlockDataAt(Vector3i position, int layer) {
        return getBlockDataAt(position.getX(), position.getY(), position.getZ(), layer);
    }
