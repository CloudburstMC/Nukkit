...
public abstract class BaseRegionLoader {
    ...
    public BaseRegionLoader(final LevelProvider level, final int regionX, final int regionZ, final String ext) {
        try {
            this.x = regionX;
            this.z = regionZ;
            this.levelProvider = level;
            final String filePath = this.levelProvider.getPath() + "region/r." + regionX + '.' + regionZ + '.' + ext;
