 ...
 * @author DaPorkchop_
 */
final class BlockReplacerDeserializer extends JsonDeserializer<BlockReplacer> {
    @Override
    public BlockReplacer deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JsonProcessingException {
        ...
        return id == BiomeGenerationPass.ID
                ? BiomeGenerationPass.INSTANCE : Nukkit.YAML_MAPPER.readValue(p, StandardGeneratorRegistries.blockReplacer().get(id));
    }
}
