...
public enum MetadataConstants {
    ...
    public enum Type {
        ...
        STRING {
            @Override
            public Object read(ByteBuf buf) {
                return BedrockUtil.readString(buf);
            }

            @Override
            public void write(ByteBuf buf, Object o) {
                BedrockUtil.writeString(buf, (String) o);
            }
        },
        ITEM {
            @Override
            public Object read(ByteBuf buf) {
                return BedrockUtil.readItemInstance(buf);
            }

            @Override
            public void write(ByteBuf buf, Object o) {
                BedrockUtil.writeItemInstance(buf, (ItemInstance) o);
            }
        },
        VECTOR3I {
            @Override
        ...
        LONG {
            @Override
            public Object read(ByteBuf buf) {
                return VarInts.readLong(buf);
            }

            @Override
            public void write(ByteBuf buf, Object o) {
                VarInts.writeLong(buf, (long) o);
            }
        },
        VECTOR3F {
            @Override
            public Object read(ByteBuf buf) {
                return BedrockUtil.readVector3f(buf);
            }

            @Override
            public void write(ByteBuf buf, Object o) {
                BedrockUtil.writeVector3f(buf, (Vector3f) o);
            }
        };
