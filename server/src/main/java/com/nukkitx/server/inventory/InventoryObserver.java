...
public interface InventoryObserver {
     ...
     */
    void onInventorySlotChange(int slot, @Nullable ItemInstance oldItem, @Nullable ItemInstance newItem, Inventory inventory, @Nullable NukkitPlayerSession session);
