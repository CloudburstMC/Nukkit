...
public class BlockUtils {
    public static final BlockState AIR = new NukkitBlockState(BlockTypes.AIR, null, null);
    ...
    public static BlockState createBlockState(Vector3i position, BlockFace face, ItemStack item) {
