 ...
 * A task can be executed by Nukkit NukkitServer with a/an express, delay, repeat or delay&repeat.
...
public abstract class Task implements Runnable {
     ...
     *                    The elapsed tick count from the NukkitServer is started. 20ticks = 1second, 1tick = 0.05second.
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
