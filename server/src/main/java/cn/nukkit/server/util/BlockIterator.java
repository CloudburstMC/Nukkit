...
public class BlockIterator implements Iterator<Block> {
    ...
    public BlockIterator(NukkitLevel level, Vector3 start, Vector3 direction) {
        this(level, start, direction, 0);
    }

    public BlockIterator(NukkitLevel level, Vector3 start, Vector3 direction, double yOffset) {
        this(level, start, direction, yOffset, 0);
    }

    public BlockIterator(NukkitLevel level, Vector3 start, Vector3 direction, double yOffset, int maxDistance) {
        this.level = level;
