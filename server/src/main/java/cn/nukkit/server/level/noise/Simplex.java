package cn.nukkit.server.level.noise;
...
public class Simplex extends Perlin {
    ...
    public Simplex(NukkitRandom random, float octaves, float persistence) {
    ...
    public Simplex(NukkitRandom random, float octaves, float persistence, float expansion) {
