...
public class ItemBow extends ItemTool {
    ...
    public boolean onReleaseUsing(Player player) {
        ...
        int diff = (NukkitServer.getInstance().getTick() - player.getStartActionTick());
        ...
        NukkitServer.getInstance().getPluginManager().callEvent(entityShootBowEvent);
        if (entityShootBowEvent.isCancelled()) {
            ...
            if (entityShootBowEvent.getProjectile() instanceof EntityProjectile) {
                ...
                NukkitServer.getInstance().getPluginManager().callEvent(projectev);
